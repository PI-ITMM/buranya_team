...
public class CellAnimation : MonoBehaviour
{
    ...
    public void Move(Cell from, Cell to, bool isMerging)
    {
        ...
        points.color = from.Value <= 2 ?
            ColorManager.Instance.PointsDarkColor : ColorManager.Instance.PointsLightColor;
        ...
        if (isMerging)
        {
            sequence.AppendCallback(() =>
            {
                ...
                points.color = points.color = to.Value <= 2 ?
                    ColorManager.Instance.PointsDarkColor : ColorManager.Instance.PointsLightColor;
            });
    ...
    public void Appear(Cell cell)
    {
        ...
        points.color = points.color = cell.Value <= 2 ?
            ColorManager.Instance.PointsDarkColor : ColorManager.Instance.PointsLightColor;
